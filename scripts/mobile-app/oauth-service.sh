...
set -o allexport
source ./etc/common_var
LOG_FILE=$SERVICE
set +o allexport

BINDIR=$ROOTDIR/bin
OPTIONS="-Xmx200M"
PIDFILE=/var/run/mobile-app/$SERVICE.pid
...
case "$1" in
    start)
        ...
        then
            ...
            java $OPTIONS -jar $BINDIR/$SERVICE.jar $CONFIG 1> $LOG_PATH/$SERVICE.log 2> $LOG_PATH/$SERVICE.log& echo $! >$PIDFILE
